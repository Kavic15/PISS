...
for x in range(25):
    ...
    send_multipart_post(bearer=bearer,userid=random.choice(bluestudent_id),message=create_post("random_posts.txt"), exid=exid, platform=platform[0], likes=likes, shares=shares)
